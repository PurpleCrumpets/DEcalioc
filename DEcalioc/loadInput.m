...
function [Input, optim, modelVars, assign, paramLims] = loadInput()
  ...
  %                                            rpm  filling degree 
  Input.model{1}       =   'Fill_25_02_rpm'; % 02   25%       
  Input.model{2}       =   'Fill_50_02_rpm'; % 02   50%
  Input.model{3}       =   'Fill_25_40_rpm'; % 40   25%
  Input.model{4}       =   'Fill_50_40_rpm'; % 40   50% 
  ...
  %  - Input.numOfSam         : number of samples generated by latin hypercubic sampling
  Input.numOfSam       =   21; % recommended 5-10 samples per factor
  ...
  % Model 2
  optim.targetVal{2}(1) =   420;
  optim.targetVal{2}(2) =   0.02;
  % Model 3
  optim.targetVal{3}(1) =   420;
  optim.targetVal{3}(2) =   0.02;
  % Model 4
  optim.targetVal{4}(1) =   420;
  optim.targetVal{4}(2) =   0.02;

  % Model 1
  optim.tolRes{1}(1)   =   0.01; % Examples provided were 0.01 to 0.05
