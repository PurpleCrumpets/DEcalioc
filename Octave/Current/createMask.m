function mask = createMask(imageStructName)
...
if isa(imageStructName,'cell')
  imageStructName = char(imageStructName);
end


%%% Import Image
pathImDir = fullfile(pathProject,'images');
ImPath = fullfile(pathImDir, imageStructName);
Im = imread(ImPath);
